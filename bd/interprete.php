...
if (!empty($_GET["n"])) {
	$lettre = $_GET["n"];
	$requete = "Select Nom_Musicien, Prénom_Musicien, Code_Musicien, Photo from Musicien Inner Join Interpréter ON Interpréter.Code_Musicien = Musicien.Code_Musicien Where Nom_Musicien Like '$lettre%'";
